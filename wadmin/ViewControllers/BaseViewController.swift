...
//        btnShowMenu.setImage(self.defaultMenuImage(), for: UIControlState())
        btnShowMenu.setImage(UIImage(named: "menu.png"), for: UIControlState())
        btnShowMenu.frame = CGRect(x: 0, y: 0, width: 30, height: 50)
...
//        UIBezierPath(rect: CGRect(x: 0, y: 10, width: 20, height: 2)).fill()
